...
async function relayV2InitUpload(roomId, sessionDraft) {
  const cleanRoomId = normalizeRoomIdValue(roomId);
  return relayApiRequest("/api/v2/relay/uploads/init", {
    method: "POST",
    roomId: cleanRoomId,
    body: {
      roomId: cleanRoomId,
...
async function relayV2GetPartUploadUrl(roomId, sessionId, partNumber) {
  const cleanRoomId = normalizeRoomIdValue(roomId);
  return relayApiRequest("/api/v2/relay/uploads/part-url", {
    method: "POST",
    roomId: cleanRoomId,
    body: {
      roomId: cleanRoomId,
...
async function relayV2CompleteUpload(roomId, sessionId, parts) {
  const cleanRoomId = normalizeRoomIdValue(roomId);
  return relayApiRequest("/api/v2/relay/uploads/complete", {
    method: "POST",
    roomId: cleanRoomId,
    body: {
      roomId: cleanRoomId,
...
async function relayV2AbortUpload(roomId, sessionId) {
  const cleanRoomId = normalizeRoomIdValue(roomId);
  return relayApiRequest("/api/v2/relay/uploads/abort", {
    method: "POST",
    roomId: cleanRoomId,
    body: {
      roomId: cleanRoomId,
...
async function relayV2GetDownloadUrl(roomId, objectKey) {
  const cleanRoomId = normalizeRoomIdValue(roomId);
  return relayApiRequest("/api/v2/relay/attachments/download-url", {
    method: "POST",
    roomId: cleanRoomId,
    body: {
      roomId: cleanRoomId,
